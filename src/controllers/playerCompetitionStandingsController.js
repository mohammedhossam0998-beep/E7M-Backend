...
const getPlayerCompetitionStandings = async (req, res) => {
  try {
    ...
    const playerId = playerResult.rows[0].user_id;
    ...
    // ========================================================
    // 5. CHECK PLAYER PARTICIPATION
    //
    // Player can participate:
    // - Directly as an individual player
    // - Through a team that they captain
    // ========================================================
    ...
    // ========================================================
    // 8. GET COMPLETED LEAGUE MATCHES
    // ========================================================
    ...
    standings.sort((a, b) => {
      for (const breaker of tieBreakers) {
        ...
        // FAIR PLAY
        //
        // No fair-play/card data currently exists
        // in the matches schema.
        // ====================================================
    ...
    console.error(
      "GET PLAYER COMPETITION STANDINGS ERROR:",
      error
    );
    ...
    return res.status(500).json({
      success: false,
      message:
        "Failed to get player competition standings",
    });
  }
};
