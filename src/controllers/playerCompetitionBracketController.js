...
// ============================================================
// GET PLAYER COMPETITION BRACKET
// GET /api/player/competitions/:competitionId/bracket
// ============================================================

const getPlayerCompetitionBracket = async (req, res) => {
  try {
    ...
    // --------------------------------------------------------
    // 3. Bracket is only available for knockout formats
    // --------------------------------------------------------
    ...
    return res.status(200).json({
      ...
      participation: {
        ...
        status:
          participationResult.rows[0].status,
      },

      generated:
        matchesResult.rows.length > 0,
    ...
    console.error(
      "GET PLAYER COMPETITION BRACKET ERROR:",
      error
    );
